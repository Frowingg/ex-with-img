...
1
    ...
    def __lt__(self, other):
        "Permette di ordinare liste di colori in base alla luminosità"
    ...
    def luminosita(self):
        "Calcola la luminosità media del pixel"
        return (self._R + self._G + self._B)//3
    
    def grigio(self):
        "crea il colore grigio con la stessa luminosità"
    ...
    def contrasto(self, k):
        ...
        return ((self-Colore.grey)*k)+grey
    ...
    def illumina(self, k):
        "crea il colore in cui si aumenta/diminuisce la luminosità di un fattore k"
        return self*k
...
#                pass
    ...
    # FIXME: non più necessaria ora che abbiamo i filtri
    '''
    def bw(self):
    ...
    # TODO - iterando sul lato più lungo
...
try:
    # codice che può generare ValueError o IndexError o altri
except ValueError as ve:
    # codice da eseguire se è avvenuto un ValueError
    print(ve)
except IndexError as ie:
    # codice da eseguire se è avvenuto un IndexError
    print(ie)
    raise ie         # rilancio l'errore in modo che continui a propagarsi
except Exception as e:
    # codice da eseguire per tutti gli errori che non già catturato (altri)
    print(e)
finally:
